...
'''image数据集-pytorch数据集'''
class img_pytorch:
    def __init__(self, path,batchsize): #必须要有一个self参数，
        self.path = path
...
if __name__ == '__main__':
    opt = img_pytorch('C:/Users/Administrator/Desktop/yolov5-master/washhand/handpoint_labels/synth1/',32)
    image,keypoint=opt.read_image()
    print(len(image))
